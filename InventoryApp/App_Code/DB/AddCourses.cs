...
public class AddCourses
{
    ...
    public static Int64 InsertCourses(string CourseCode, string CourseTitle, string Userid, string Ipaddress)
    {
        ...
        try
        {
            ...
            SqlParameter paramCODE = new SqlParameter("@paramCODE", SqlDbType.VarChar, 70);
            paramCODE.Value = GetNonNumericData(CourseCode);
            ...
            SqlParameter paramUSERID = new SqlParameter("@paramUSERID", SqlDbType.VarChar, 100);
            paramUSERID.Value = Userid;
            paramUSERID.Direction = ParameterDirection.Input;
            cmd.Parameters.Add(paramUSERID);

            SqlParameter paramOPERATIONS = new SqlParameter("@paramOPERATIONS", SqlDbType.VarChar, 500);
            paramOPERATIONS.Value = Operation;
            paramOPERATIONS.Direction = ParameterDirection.Input;
            cmd.Parameters.Add(paramOPERATIONS);

            
            SqlParameter paramIPADDRESS = new SqlParameter("@paramIPADDRESS", SqlDbType.VarChar, 500);
            paramIPADDRESS.Value = Ipaddress;
            paramIPADDRESS.Direction = ParameterDirection.Input;
    ...
    public static Int64 UpdateCourses(string courseid, string CourseCode, string CourseTitle, bool Activated, string Userid, string Ipaddress)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
    ...
    public static Int64 InsertCourseType(string CourseType, string Userid, string Ipaddress)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
        ...
        try
        {
            ...
            SqlParameter paramCODE = new SqlParameter("@paramCODE", SqlDbType.VarChar, 170);
            paramCODE.Value =GetNonNumericData( CourseType);
            paramCODE.Direction = ParameterDirection.Input;
            cmd.Parameters.Add(paramCODE);
    ...
    public static Int64 UpdateCourseType(string CourseTypeid, string CourseType, bool Activated, string Userid, string Ipaddress)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
    ...
    public static Int64 InsertAssignedCourses(string deptid, string studenttype, string yearofstudy, string semesterid, string courseid, string coursetype, string courseunit, string deptoptionid, string modeofentry, string Userid, string Ipaddress)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
        ...
        try
        {
            ...
            SqlParameter paramDEPARTMENTOPTIONID = new SqlParameter("@paramDEPARTMENTOPTIONID", SqlDbType.VarChar, 170);
            paramDEPARTMENTOPTIONID.Value = deptoptionid;
            paramDEPARTMENTOPTIONID.Direction = ParameterDirection.Input;
            cmd.Parameters.Add(paramDEPARTMENTOPTIONID);
            ...
            SqlParameter paramMODEOFENTRYID = new SqlParameter("@paramMODEOFENTRYID", SqlDbType.VarChar, 170);
            paramMODEOFENTRYID.Value = modeofentry;
            paramMODEOFENTRYID.Direction = ParameterDirection.Input;
            cmd.Parameters.Add(paramMODEOFENTRYID);
    ...
    public static bool DeleteAssignedCourses(string id, string Userid, string Ipaddress)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
    ...
    public static bool UpdateActivationStatusForAssignedCourses(string id, bool status, string Userid, string Ipaddress)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
    ...
    public static Int64 ModifyUnitLoad(string deptid, string studenttype, string yearofstudy, string semesterid, string MaxUnit, string MinUnit, string MaxelecUnit, string deptOptionid)
    {
        string constr = ConfigurationManager.AppSettings["ConnStr"];
        ...
        try
        {
            ...
            SqlParameter paramMAXELECUNIT = new SqlParameter("@paramMAXELECUNIT", SqlDbType.VarChar, 70);
            paramMAXELECUNIT.Value = MaxelecUnit;
            paramMAXELECUNIT.Direction = ParameterDirection.Input;
            cmd.Parameters.Add(paramMAXELECUNIT);
    ...
    public static bool IsCourseAssignforDepartment(string departmentid,string departmentoptionid ,string studenttypeid, string yearofstudyid, string semesterid,string modeofentry)
    {
        try
        {

            DataSet dsCourse = ConnectDB.LoadDatasource("Select * from COURSE_ASSIGN_FOR_DEPARTMENT where SEMESTER_ID ='" + semesterid + "' and STUDENT_TYPE_ID ='" + studenttypeid + "' and DEPARTMENT_ID ='" + departmentid + "' and YEAR_OF_STUDY_ID ='" + yearofstudyid + "' and DEPARTMENT_OPTION_ID  ='" + departmentoptionid + "' and  STUDENT_MODE_OF_ENTRY_ID ='" + modeofentry + "' AND ACTIVATED ='TRUE'");
            if (dsCourse != null)
            {
    ...
    public static bool IsUnitLoadAssignforDepartment(string departmentid, string deptoption,string studenttypeid, string yearofstudyid, string semesterid, string modeofentryid)
    {
        try
        {

            DataSet dsCourse = ConnectDB.LoadDatasource("Select * from COURSE_DEPARTMENT_UNIT_LOAD where SEMESTER_ID ='" + semesterid + "' and STUDENT_TYPE_ID ='" + studenttypeid + "' and DEPARTMENT_ID ='" + departmentid + "' and YEAR_OF_STUDY_ID ='" + yearofstudyid + "' AND DEPARTMENT_OPTION_ID ='" + deptoption + "' AND STUDENT_MODE_OF_ENTRY_ID ='" + modeofentryid + "'");
            if (dsCourse != null)
            {
                if (dsCourse.Tables[0].Rows.Count > 0)
                {
