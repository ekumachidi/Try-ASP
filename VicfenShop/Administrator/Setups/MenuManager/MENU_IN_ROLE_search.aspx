<%@ Page Language="c#" AutoEventWireup="true" CodeFile="MENU_IN_ROLE_search.aspx.cs" Inherits="CMENU_IN_ROLE_search"%>
<HTML>
  <HEAD>
    <title>dbo.MENU_IN_ROLE - Advanced search page</title>
  ...
  <body bgcolor="white" onLoad="javascript:document.forms[0].onkeydown = OnKeyDown; return ShowHideControls();">
    <form id="frmSearch" method="post" runat="server">
      <table  cellSpacing="-1" cellPadding="1" width="750" align="center" style="BORDER: #cccccc 1px solid;">
        ...
        <td width=200 class=tableheader>dbo.MENU_IN_ROLE</td>
        ...
        <td align="center">
                  <asp:CheckBox ID="chNot_MenuId" runat="server" />                  
                </td>
                <td align="center" width="1">
                  <asp:dropdownlist id="ddlOperation_MenuId" runat="server" onChange="return ShowHideControls();">
                    <asp:ListItem Value="Equals">Equals</asp:ListItem>                  
                  </asp:dropdownlist>
                </td>
                <td align="left" width="33%">                         
                  <asp:dropdownlist id="fldMenuId" DataTextField="MenuTitle" DataValueField="MenuId" runat="server" Width="100%" ></asp:dropdownlist>
                </td>
                <td align="left" width="33%">
                  &nbsp;
                </td>
