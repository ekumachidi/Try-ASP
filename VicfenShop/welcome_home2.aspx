...
<frameset style="background-color:#FFFFFF" rows="*,10%" id="parent" frameborder="no" border="1" framespacing="0">
    <frameset rows="70,*" frameborder="no" border="1" framespacing="0">
      <frame src="default_header.aspx" name="header" id="header" title="Header"  scrolling="No" noresize="noresize" />
      
      <frameset cols="220,*" frameborder="1" border="1" framespacing="0">
        <frame src="menu.aspx" name="menu" id="menu" title="Content"  />
